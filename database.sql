-- Basotho Business Recommender Database Schema
-- Version: 1.0.0
-- Created: 2024
...
(1, 'testuser', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'test@example.com');

-- Sample recommendation
INSERT IGNORE INTO recommendations (user_id, skills, interests, capital, location, availability, problem_solved, business_title, business_description, reason_for_fit, estimated_capital, suggested_schedule, language) VALUES
...
-- Sample feedback
INSERT IGNORE INTO business_feedback (user_id, idea, feedback, skills, interests, capital, location, availability, language) VALUES
